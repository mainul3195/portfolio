...
import { FaLaptopCode, FaUserGraduate, FaTableTennis, FaDesktop, FaUsers, FaAward, FaFlask, FaPalette } from 'react-icons/fa';
...
export default function AchievementsSection({ onOpenModal }: AchievementsSectionProps) {
  const container = {
    hidden: { opacity: 0 },
    show: {
      opacity: 1,
  ...
  return (
    <section id="achievements" className="py-16">
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold text-white/90 mb-3">Explore My Journey</h2>
          <p className="text-slate-400/80">Click on any card to learn more about each aspect</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-[calc(60%)] mx-auto">
          <AchievementCard
            icon={<FaAward className="w-10 h-10 text-yellow-300/80" />}
            title="President Scout"
