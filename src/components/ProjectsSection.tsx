...
const projects = [
  {
    ...
    description:
      "An online learning platform for Shahjalal University of Science and Technology that serves as a centralized repository for course materials. Led the project as Project Manager.",
    tech: [
  ...
  return (
    <section id="projects" className="py-20">
      <div className="max-w-6xl mx-auto">
        <motion.h2 className="text-4xl md:text-5xl font-bold mb-12 text-slate-100">
          Projects
        </motion.h2>
            ...
            >
              <div className="relative h-48 bg-gradient-to-br from-slate-800 to-slate-900/50 overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center text-slate-600">
                  <div className="text-6xl">{project.tech[0].icon}</div>
                </div>
              </div>
